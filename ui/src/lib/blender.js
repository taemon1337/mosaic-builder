...
export const blendModes = 'white normal src-over screen multiply difference src-in plus add overlay hardlight colordodge dodge colorburn burn darken darker lighten lighter exclusion softlight luminosity color hue saturation lightercolor darkercolor'.split(' ');

export const Fsoftlight = function(a,b) {
  /*
...
export const Foverlay = function(a,b) {
  return a<128 ?
    (a*b)>>7 : // (2*a*b)>>8 :
    255 - (( (255 - b) * (255 - a))>>7);
}

export const Fdodge = function(a,b) {
  return (b==255 && a==0) ? 255 : Math.min(255,(a<<8)/(255-b));
}

export const Fburn = function(a,b) {
...
*/
export const rgb2YCbCr = function(r,g,b) {
  return {
...
*/
export const YCbCr2rgb = function(r,g,b) {
  return {
    r: r +1.4020*b,
...
export const blendOnto = function(srcContext, destContext, blendMode, offsetOptions) {
		var offsets={};
        ...
        break;
				...
				case 'plus':
				case 'add':
					// Photoshop doesn't simply add the alpha channels; srcContext might be correct wrt SVG 1.2
